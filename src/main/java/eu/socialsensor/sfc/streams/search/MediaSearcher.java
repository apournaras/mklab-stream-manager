...
public class MediaSearcher {
	...
	public synchronized void open() throws StreamException {
		...
		this.trendingSearchHandler = new TrendingSearchHandler(this, dyscosToUpdate);
		this.customSearchHandler = new CustomSearchHandler(this, requestsToDelete);
		...
		this.listener = new Thread(new Runnable() {
            ...
            public void run() {
                try {          
                    ...
                    jedisClient.subscribe(dyscoRequestReceiver, config.getParameter(MediaSearcher.REDIS_CHANNEL));  
